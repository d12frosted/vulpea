...
Aliases are stored in the =ROAM_ALIASES= property (configurable):

#+begin_src org
:PROPERTIES:
:ID: abc123
:ROAM_ALIASES: "PKM" "Personal Knowledge Management"
:END:
#+title: Zettelkasten
#+end_src
...
By default, aliases are stored in =ROAM_ALIASES=. To change:
...
- [[file:journal.org][Journal Module]] - Daily notes with widgets
