...
- *Non-blocking sync* - File watchers feed a background queue, and an opt-in worker process takes parsing off the main thread
...
*Building applications* - Vulpea provides a foundation for note-based apps. [[https://github.com/d12frosted/vino][Vino]] uses Vulpea to manage wine collections with ratings, producers, and regions. [[https://github.com/d12frosted/vulpea-journal][vulpea-journal]] provides daily notes with widgets.
