...
*Note:* v2 is not yet released to package archives. Install from source or use a package manager that supports Git.

#+begin_src emacs-lisp
;; Using straight.el
(straight-use-package
 '(vulpea :host github :repo "d12frosted/vulpea"))
